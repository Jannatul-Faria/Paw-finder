...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Pet Update</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">Pet Update</li>
                </ol>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{$pet-> name}}" class="form-control" name="name" placeholder="">
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{$pet-> name}}" class="form-control" name="breed" placeholder="">
                                @error('breed')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="specie_id[]" id="choices-multiple" multiple>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="category_id">Category
                                    <span class="text-danger">*</span></label>
                                <select class="form-control form-select" id="choices-multiple2" name="category_id[]"
                                    multiple>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="special_needs">
                                    <option value="" selected disabled>Select</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="fee" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="city_id">Location</label>
                                <select class="form-control form-select" id="choices-multiple3" name="city_id[]"
                                    multiple>
                        ...
                        <div class="col-md-2 d-flex justify-content-center">
                            <div class="mb-3">
                                <label class="form-label" for="location">Preview</label><br>
                                <img class="rounded avatar-md"
                                    src="{{ asset('backend') }}/assets/images/small/img-4.jpg" alt="Image">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="images">Multiple Image</label>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea id="ckeditor-classic" class="form-control" name="details"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="mt-4">
