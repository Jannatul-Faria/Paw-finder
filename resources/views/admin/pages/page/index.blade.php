    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Page List</h4>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h5>Page List</h5>
                    <a class="btn btn-sm btn-primary" href="{{ route('admin.pages.create') }}"><i
                    ...
                    <table class="table table-bordered  datatable table-check dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                            @foreach ($allPage as $page)
                                <tr>
                                    <td>{{ $page->name }}</td>
                                    <td class="text-wrap">{!! Str::limit($page->content, 20, '...') !!}</td>

                                    <td>{{ $page->url }}</td>
                                    <td>
                                        <div class="badge badge-soft-success font-size-12">

                                            {{ $page->is_status == 1 ? 'Active' : 'Inactive' }}
                                        </div>
                                    </td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                <a class="dropdown-item" href="#"><i
                                                    ...
                                                    Show</a>
                                                <a class="dropdown-item" href="{{ route('admin.pages.edit', $page) }}"><i
